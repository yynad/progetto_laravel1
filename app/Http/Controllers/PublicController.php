...
return [
new Middleware('auth', except:['homepage', 'index']),
];
    ...
    public function store(StoreBookRequest $request){
        $book = Book::create([
            'title'=>$request->title,
            'genre'=>$request->genre,
            // 'cover'=>$request->file('cover')->store('book-cover', 'public'),
    ...
    public function index(){
        // query al database per recuperare tutti gli oggetti di classe book
        $books = Book::all();
